    ...
    var jBox = function jBox(type, options) {
        ...
        this._showOverlay = function () {
            ...
            if (!this.overlay) {
                ...
                this.overlay = jQuery('<div id="' + this.id + '-overlay"/>').addClass('jBox-overlay-admin' + (this.type ? ' jBox-overlay-' + this.type : '')).css({
                    display: 'none',
                    opacity: 0,
...
$(function () {
    ...
    $('.modal-open').on('click', function () {
        var id = $(this).attr('data-modal-id'); // data-modal-id 속성 값 가져오기

        // data-modal-id 값에 따른 조건 설정
        if (id === 'register-club-mem') {
            // 클럽회원 추가하기 모달
            $('#register-club-mem').show();
            new jBox('Add', {
                width: 800,
                height: 500,
                closeButton: 'title',
                ...
                content: $('#' + id), // id를 사용하여 모달 콘텐츠 선택
                confirmButton: "추가하기",
                closeOnConfirm: true,
            }).open(); // jBox 모달 열기

        } else if (id === 'modify-club-mem') {
            // 클럽회원 수정하기 모달
            $('#modify-club-mem').show();
            new jBox('Add', {
                width: 600,
                height: 350,
                closeButton: 'title',
        ...
        }  else if (id === 'delete-club-mem') {
            // 클럽회원 삭제하기 모달
            $('#delete-club-mem').show();
            new jBox('Delete', {
                addClass: 'modal-confirm-delete',
                content: $('#' + id), // id를 사용하여 모달 콘텐츠 선택
                confirmButton: "확인",
                cancelButton: '아니오',
                closeOnConfirm: true,
        ...
        else if (id === 'register-group-club') {
            // 클럽추가하기  모달
            $('#register-group-club').show();
            new jBox('Add', {
                width: 800,
                height: 500,
                closeButton: 'title',
        ...
        else if (id === 'delete-group-club') {
            // 클럽삭제하기  모달
            $('#delete-group-club').show();
            new jBox('Delete', {
                addClass: 'modal-confirm-delete',
                content: $('#' + id), // id를 사용하여 모달 콘텐츠 선택
                confirmButton: "확인",
        ...
        else if (id === 'delete-normal-mem') {
            // 일반회원 삭제하기  모달
            $('#delete-normal-mem').show();
            new jBox('Delete', {
                addClass: 'modal-confirm-delete',
                content: $('#' + id), // id를 사용하여 모달 콘텐츠 선택
                confirmButton: "확인",
