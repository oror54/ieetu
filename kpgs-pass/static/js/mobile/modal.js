function jBoxWrapper(jQuery) {
    ...
    var jBox = function jBox(type, options) {
        ...
        this.options = {
            ...
            // Other options
            appendTo: jQuery('#mobile'),    // The element your jBox will be appended to. Any other element than jQuery('body') is only useful for fixed positions or when position values are numbers
...
$(function () {
    ...
    new jBox("Back", {
        attach: '.prev',
        addClass: 'modal-cofirm',
        content: '<div class="con"> <b>입력된 내용이 사라집니다.</b> <p>이전 화면으로 이동하시겠습니까?</p></div>',
        confirmButton: "확인",
        cancelButton: '아니오',
        closeOnConfirm: true,
    });
    ...
    new jBox("Check", {
        attach: '.rsrv-change',
        addClass: 'modal-cofirm',
        content: '<div class="con"> <b>예약변경</b> <p>예약을 변경하시겠습니까?</p></div>',
        confirmButton: "확인",
        cancelButton: '아니오',
        closeOnConfirm: true,
    });
    ...
    new jBox("Check", {
        attach: '.rsrv-cancel',
        addClass: 'modal-cofirm',
        content: '<div class="con"> <b>예약취소</b> <p>예약을 취소하시겠습니까?</p></div>',
        confirmButton: "확인",
        cancelButton: '아니오',
        closeOnConfirm: true,
    });
    ...
    new jBox("Check", {
        attach: '.delete',
        addClass: 'modal-cofirm',
        content: '<div class="con"> <b>정말로 계정을 삭제하시겠습니까?</b> <p>삭제한 계정과 관련된 정보는<br>복구할 수 업습니다.</p></div>',
        confirmButton: "계정삭제",
        cancelButton: '아니오',
        closeOnConfirm: true,
    });
    ...
    new jBox("Check", {
        attach: '.logout',
        addClass: 'modal-cofirm',
        content: '<div class="con"> <b>로그아웃</b> <p>로그아웃 하시겠습니까?</p></div>',
        confirmButton: "로그아웃",
        cancelButton: '아니오',
        closeOnConfirm: true,
    });
